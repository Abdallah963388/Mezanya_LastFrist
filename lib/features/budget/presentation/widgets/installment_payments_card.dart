...
class InstallmentPaymentsCard extends StatefulWidget {
  const InstallmentPaymentsCard({
    super.key,
    required this.theme,
    required this.debt,
  ...
  @override
  State<InstallmentPaymentsCard> createState() =>
      _InstallmentPaymentsCardState();
}

class _InstallmentPaymentsCardState extends State<InstallmentPaymentsCard> {
